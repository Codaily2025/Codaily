...
const Login = ({ onLogin }) => {
  ...
  const handleSocialLogin = (provider) => {
    if (provider === 'google') {
      ...
      window.location.href = 'https://i13a601.p.ssafy.io/api/oauth2/authorization/google';
    } else if (provider === 'naver') {
      // 네이버 OAuth 로그인
      window.location.href = 'https://i13a601.p.ssafy.io/api/oauth2/authorization/naver';
    } else {
      // 카카오는 아직 구현되지 않음
