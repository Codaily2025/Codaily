...
- 형식은 아래의 형식을 따르고, 다른 대화나 양식은 절대 추가하지 마세요.
...
- 시간 분배 규칙:\n
  ...
  2) 각 항목 시간은 **0.5 ~ {{time}}** 범위 양수, **0.5 단위**로 표기\n
  3) 반올림 등으로 총합이 어긋나지 않도록 합계를 정확히 {{time}}로 맞춤\n
...
- 각 항목의 예상시간은 **0.5 ~ T** 범위 양수, **0.5 단위**로 표기합니다.
- 반올림 등으로 총합이 어긋나지 않도록 상세 기능 목록의 시간 합계를 정확히 T로 맞춥니다.
...
- 시간 제약(아주 중요):\n
  ...
  3) 각 항목의 예상시간은 **0.5 ~ T** 범위 양수, **0.5 단위**로 표기\n
  - 반올림 등으로 총합이 어긋나지 않도록 합계를 정확히 T로 맞춤\n
